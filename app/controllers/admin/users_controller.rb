class Admin::UsersController < ApplicationController
    ...
    # Strong parameters to permit user attributes, including the 'admin' field
    def user_params
      params.require(:user).permit(:first_name, :last_name, :bio, :city, :country, :email, :password, :password_confirmation, :admin)
    end
end
